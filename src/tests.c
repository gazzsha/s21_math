...
//   ck_assert_double_eq_tol(s21_fabs(-14720.5689), fabs(-14720.5689),
//   0.000001);
// }
// END_TEST
...
//   ck_assert_double_eq_tol(s21_sin(PI), sin(PI), 0.000001);
// }
// END_TEST

// START_TEST(s21_sin_test7) {
//   ck_assert_double_eq_tol(s21_sin(PI_2), sin(PI_2), 0.000001);
// }
// END_TEST
...
//   ck_assert_double_eq_tol(s21_cos(PI_2), cos(PI_2), 0.000001);
// }
// END_TEST
...
//   ck_assert_double_eq_tol(s21_cos(PI), cos(PI), 0.000001);
// }
// END_TEST
...
//   ck_assert_double_eq_tol(s21_tan(PI), tan(PI), 0.000001);
// }
// END_TEST
...
//   ck_assert_double_nan(s21_fmod(INFINITY, 543.3));
//   ck_assert_double_nan(fmod(INFINITY, 543.3));
// }
// END_TEST
...
//   long double f_value[] = {4234, 20,      234,    -756,   435,    24.342,
//   345,
...
//   for (int i = 0; i < 5; i++)
//     ck_assert_double_eq(functorial(fuct_arr[i]), fuct_ans_arr[i]);
// }
// END_TEST
...
//   ck_assert_double_eq(s21_pow(-INFINITY, -INFINITY), pow(-INFINITY,
//   -INFINITY));
// }
// END_TEST
